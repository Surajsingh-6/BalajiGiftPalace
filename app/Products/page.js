        ...
        <div>
            ...
            <div className="flex flex-wrap p-2 ">
                {prod.map((product, index) => (
                    ...
                    <div
                        key={index}
                        className={`my-5 w-80 h-64  mx-auto border-2 border-[#9d9d9d]  rounded-lg `}
                    >
                        ...
                        <div className="flex justify-between items-center px-2">
                            <h2 className="text-sm px-2 font-medium text-stone-900">
                                {product.short_title}
                            </h2>
                            <button className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2 text-center me-2 mb-2">
